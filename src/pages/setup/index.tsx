...
import { MainLayout, SetTeamName } from "src/components";
...
const Setup: FC<Props> = ({ setAppState }) => {
  ...
  return (
    <MainLayout
      leftContent={
        <SetTeamName number={1} name={teamOneName} setName={setTeamOneName} />
      }
      rightContent={
        <SetTeamName number={2} name={teamTwoName} setName={setTeamTwoName} />
      }
